  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (!response.ok) {
        ...
        let errorMessage = 'Có lỗi xảy ra khi lưu môn học';
        if (data.errors) {
  ...
  return (
    <Container maxWidth="lg" sx={{ mt: 4, mb: 4 }}>
      ...
      <Box display="flex" justifyContent="space-between" alignItems="center" mb={4}>
        ...
        {(isSuperAdmin() || hasPermission('them-moi-mon-hoc')) && (
          <Button
            variant="contained"
            color="primary"
            startIcon={<AddIcon />}
                    ...
                    <TableRow key={course.id} hover>
                      ...
                      <TableCell align="center">
                        <Box display="flex" gap={1} justifyContent="center">
                          {(isSuperAdmin() || hasPermission('chinh-sua-mon-hoc')) && (
                            <IconButton
                              size="small"
                              color="primary"
                          ...
                          {(isSuperAdmin() || hasPermission('xoa-mon-hoc')) && (
                            <IconButton
                              size="small"
                              color="error"
                          ...
                          {!isSuperAdmin() && !hasPermission('chinh-sua-mon-hoc') && !hasPermission('xoa-mon-hoc') && (
                            <Typography variant="caption" color="text.secondary">
                              Không có quyền
                            </Typography>
                          )}
