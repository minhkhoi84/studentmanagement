                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="text" 
                                                   ...
                                                   id="nationality" 
                                                   name="nationality" 
                                                   value="{{ old('nationality', 'Vietnamese') }}" 
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group mb-3">
                                            ...
                                            <textarea class="form-control @error('emergency_contact') is-invalid @enderror" 
                                                      ...
                                                      rows="3" 
                                                      placeholder="Enter emergency contact details">{{ old('emergency_contact') }}</textarea>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group mb-3">
                                            ...
                                            <textarea class="form-control @error('medical_conditions') is-invalid @enderror" 
                                                      ...
                                                      rows="3" 
                                                      placeholder="Enter any medical conditions or allergies">{{ old('medical_conditions') }}</textarea>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group mb-3">
                                            ...
                                            <textarea class="form-control @error('notes') is-invalid @enderror" 
                                                      ...
                                                      name="notes" 
                                                      rows="4" 
                                                      placeholder="Enter any additional notes about the student">{{ old('notes') }}</textarea>
                                            @error('notes')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
